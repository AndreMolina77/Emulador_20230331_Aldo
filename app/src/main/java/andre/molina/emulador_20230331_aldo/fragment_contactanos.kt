package andre.molina.emulador_20230331_aldo
...
class fragment_contactanos : Fragment() {
    ...
    override fun onCreateView(
        ...
        val correoElectronico = root.findViewById<Button>(R.id.btnCorreo)
        correoElectronico.setOnClickListener {
            Toast.makeText(requireContext(), "Mi código estudiantil es: 20230331", Toast.LENGTH_LONG).show()
        }
        return root
    }
